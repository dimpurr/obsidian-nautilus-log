...
var logCoreModule = __toESM(require_log_core());
var core = logCoreModule;
var STOP_PLAYBACK_LABEL = {
  en: "Stop playback",
  zh: "\u505C\u6B62\u56DE\u653E"
};
...
var ICON_EYE = '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle>';
var ICON_EYE_OFF = '<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1 -2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line>';
var ICON_PLAY = '<polygon points="5 3 19 12 5 21 5 3"></polygon>';
var ICON_STOP = '<rect x="5" y="5" width="14" height="14" rx="2"></rect>';
var ICON_COLLAPSE = '<rect x="3" y="4" width="18" height="16" rx="2.5"></rect><path d="M3 9h18"></path><path d="m9 16 3-3 3 3"></path>';
var ICON_EXPAND = '<rect x="3" y="4" width="18" height="16" rx="2.5"></rect><path d="M3 9h18"></path><path d="m9 13 3 3 3-3"></path>';
...
function writeCollapsed(storageKey, value) {
  try {
    window.localStorage.setItem(storageKey, String(value));
  } catch {
  }
}
function copyLabel(copy, key, fallback) {
  const value = copy && copy[key];
  return typeof value === "string" && value.length > 0 ? value : fallback;
}
function setButtonA11y(btn, label, pressed) {
...
function renderChartControls(container, state, handlers, settings, opts, storageKey) {
  ...
  function startPlayback() {
    ...
    if (end <= opts.workdayStartMinutes)
      return;
